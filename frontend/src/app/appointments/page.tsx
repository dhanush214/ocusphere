...
export default function AppointmentPage() {
  ...
  async function handleSubmit(
    ...
    if (!form.provider.trim()) {
      setError(
        "Please select an OcuSphere registered provider."
      );
      return;
    }
    ...
    if (!providerId.trim()) {
      setError(
        "Please return to Find Eye Care and select a registered OcuSphere provider before requesting an appointment."
      );
      return;
    }
    ...
    try {
      ...
      */
      ...
      const appointmentData = {
        ...
        providerId:
          backendAppointment?.provider_id ||
          providerId.trim(),
      ...
      <div className="mx-auto max-w-6xl px-6 py-12 md:px-8 md:py-16">
        ...
        <section className="mt-10">
          ...
          <p className="mt-4 max-w-3xl text-lg leading-8 text-slate-400">
            ...
            registered OcuSphere provider you selected
            on the Find Eye Care page.
          </p>
        </section>
            ...
            <div className="mt-8 grid gap-6 md:grid-cols-2">
              ...
              <label className="block">
                ...
                <input
                  ...
                  value={form.provider}
                  readOnly
                  placeholder="Select a registered provider from Find Eye Care"
                  className="mt-2 w-full cursor-not-allowed rounded-xl border border-white/10 bg-[#0b1529] px-4 py-4 text-slate-200 outline-none placeholder:text-slate-600"
                />

                {providerId && (
                  <p className="mt-2 text-xs text-emerald-300">
                    Registered Provider ID: {providerId}
                  </p>
                )}
                ...
                {!providerId && (
                  ...
                  >
                    Select an OcuSphere registered provider →
                  </Link>
                )}
              </label>
